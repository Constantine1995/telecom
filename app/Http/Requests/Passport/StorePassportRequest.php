...
//    }
    ...
    public function rules(): array
    {
        return [
            ...
            'main_photo' => ['required', 'image', 'mimes:jpeg,png', 'max:8192'],
            'registration_photo' => ['required', 'image', 'mimes:jpeg,png', 'max:8192'],
    ...
    public function messages(): array
    {
        return [
            ...
            'main_photo.max' => 'Размер фотографии не может превышать 8 МБ.',
            ...
            'registration_photo.max' => 'Размер фотографии регистрации не может превышать 8 МБ.',
